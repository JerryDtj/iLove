...
public class LoginController {
    ...
    private final String APP_ID = "101555884";
    private final String APP_Key = "f971d329363d602c0b24e08230c7756d";
    private final String redirect_uri = "https://tianzijiaozi.top/login/qqLogin";
    ...
    public String qqLogin(@RequestParam String code){
        ...
        if (StringUtils.isNotBlank(qqtoken)){
            //获取用户私人id
            String openId = this.getUserOpenId(qqtoken);
    ...
    public String getQQToken(String code){
       ...
       String qqToken = "access_token";
        if (result.contains(qqToken)){
            return result.substring(result.indexOf("access_token="),result.indexOf("&expires_in")).replace("access_token=","");
        }
        return null;
    }
